# Aqui esta el codigo del juego [PONG](https://en.wikipedia.org/wiki/Pong) en lenguaje [Python](https://www.python.org/):
...
while not game_over:
	...
	player_1 = pygame.draw.rect(screen, white, (player1_x_coord, player1_y_coord, player_width, player_height))
	player_2 = pygame.draw.rect(screen, white, (player2_x_coord, player2_y_coord, player_width, player_height))
